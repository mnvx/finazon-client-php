...
/**
 * TechnicalIndicatorResponseStoch Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseStoch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseStoch';
    ...
    {
        $this->container['slow_d'] = isset($data['slow_d']) ? $data['slow_d'] : null;
        $this->container['slow_k'] = isset($data['slow_k']) ? $data['slow_k'] : null;
    ...
    {
        return $this->container['slow_d'];
    }

    /**
     * Sets slow_d
     *
     * @param string $slow_d Slow %D value
     *
     * @return $this
     */
    public function setSlowD($slow_d)
    {
        $this->container['slow_d'] = $slow_d;
    ...
    {
        return $this->container['slow_k'];
    }

    /**
     * Sets slow_k
     *
     * @param string $slow_k Slow %K value
     *
     * @return $this
     */
    public function setSlowK($slow_k)
    {
        $this->container['slow_k'] = $slow_k;
