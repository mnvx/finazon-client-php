...
/**
 * SymbolStocks Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SymbolStocks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SymbolStocks';
     ...
     * Sets country
     *
     * @param string $country Country where exchange is located
     *
     * @return $this
     */
     ...
     * Sets publisher
     *
     * @param string $publisher Publisher code
     *
     * @return $this
     */
