...
/**
 * TechnicalIndicatorResponseMacd Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseMacd implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseMacd';
    ...
    protected static $setters = [
        'macd' => 'setMacd',
        'macd_hist' => 'setMacdHist',
        'macd_signal' => 'setMacdSignal',
        't' => 'setT'
    ];
    ...
    protected static $getters = [
        'macd' => 'getMacd',
        'macd_hist' => 'getMacdHist',
        'macd_signal' => 'getMacdSignal',
        't' => 'getT'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['macd_hist'] = isset($data['macd_hist']) ? $data['macd_hist'] : null;
        $this->container['macd_signal'] = isset($data['macd_signal']) ? $data['macd_signal'] : null;
     ...
     * Sets macd
     *
     * @param string $macd Moving Average Convergence/Divergence indicator value
     *
     * @return $this
     */
    ...
    {
        return $this->container['macd_hist'];
    }

    /**
     * Sets macd_hist
     *
     * @param string $macd_hist MACD Histogram value
     *
     * @return $this
     */
    public function setMacdHist($macd_hist)
    {
        $this->container['macd_hist'] = $macd_hist;
    ...
    {
        return $this->container['macd_signal'];
    }

    /**
     * Sets macd_signal
     *
     * @param string $macd_signal MACD signal line value
     *
     * @return $this
     */
    public function setMacdSignal($macd_signal)
    {
        $this->container['macd_signal'] = $macd_signal;
