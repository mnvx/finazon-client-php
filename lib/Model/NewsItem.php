 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NewsItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewsItem';
     ...
     * Sets author
     *
     * @param string $author Author of the news article
     *
     * @return $this
     */
     ...
     * Sets channels
     *
     * @param string[] $channels Channels of the news article
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Timestamp indicating when the news article was generated
     *
     * @return $this
     */
     ...
     * Sets images
     *
     * @param string[] $images Images of the news article
     *
     * @return $this
     */
     ...
     * Sets record_id
     *
     * @param int $record_id Unique record ID from Benzinga
     *
     * @return $this
     */
     ...
     * Sets tags
     *
     * @param string[] $tags Tags of the news article
     *
     * @return $this
     */
     ...
     * Sets tickers
     *
     * @param string[] $tickers The ticker symbols related to the news article
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Timestamp indicating when the news article was last updated
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url URL link directing to the complete news story
     *
     * @return $this
     */
