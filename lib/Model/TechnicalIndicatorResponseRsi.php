...
/**
 * TechnicalIndicatorResponseRsi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseRsi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseRsi';
    ...
    {
        $this->container['rsi'] = isset($data['rsi']) ? $data['rsi'] : null;
     ...
     * Sets rsi
     *
     * @param string $rsi Relative Strength Index (RSI) indicator value
     *
     * @return $this
     */
