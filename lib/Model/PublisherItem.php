...
/**
 * PublisherItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublisherItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublisherItem';
     ...
     * Sets code
     *
     * @param string $code Finazon code representing the publisher
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The official name of the data publisher
     *
     * @return $this
     */
