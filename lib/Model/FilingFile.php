 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FilingFile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FilingFile';
     ...
     * Sets url
     *
     * @param string $url File full url
     *
     * @return $this
     */
