...
class DatasetItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatasetItem';
     ...
     * Sets code
     *
     * @param string $code Finazon code representing the dataset
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The official name of the dataset
     *
     * @return $this
     */
