...
/**
 * MarketCenterItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketCenterItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MarketCenterItem';
     ...
     * Sets code
     *
     * @param string $code Market center code
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Market center name
     *
     * @return $this
     */
