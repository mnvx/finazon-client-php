...
/**
 * TechnicalIndicatorResponseObv Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseObv implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseObv';
    ...
    {
        $this->container['obv'] = isset($data['obv']) ? $data['obv'] : null;
    ...
    {
        return $this->container['obv'];
    }

    /**
     * Sets obv
     *
     * @param string $obv On Balance Volume (OBV) indicator value
     *
     * @return $this
     */
    public function setObv($obv)
    {
        $this->container['obv'] = $obv;
