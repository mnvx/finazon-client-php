...
/**
 * TechnicalIndicatorResponseSar Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseSar implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseSar';
    ...
    {
        $this->container['sar'] = isset($data['sar']) ? $data['sar'] : null;
     ...
     * Sets sar
     *
     * @param string $sar SAR indicator value
     *
     * @return $this
     */
