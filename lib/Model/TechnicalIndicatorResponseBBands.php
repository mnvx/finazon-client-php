...
/**
 * TechnicalIndicatorResponseBBands Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseBBands implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseBBands';
    ...
    {
        $this->container['lower_band'] = isset($data['lower_band']) ? $data['lower_band'] : null;
        $this->container['middle_band'] = isset($data['middle_band']) ? $data['middle_band'] : null;
        $this->container['t'] = isset($data['t']) ? $data['t'] : null;
        $this->container['upper_band'] = isset($data['upper_band']) ? $data['upper_band'] : null;
    }
     ...
     * Sets lower_band
     *
     * @param string $lower_band BBands Lower value
     *
     * @return $this
     */
    ...
    {
        return $this->container['middle_band'];
    }

    /**
     * Sets middle_band
     *
     * @param string $middle_band BBands Middle value
     *
     * @return $this
     */
    public function setMiddleBand($middle_band)
    {
        $this->container['middle_band'] = $middle_band;
     ...
     * Sets upper_band
     *
     * @param string $upper_band BBands Upper value
     *
     * @return $this
     */
