...
/**
 * EarningsCalendarItemEps Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EarningsCalendarItemEps implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EarningsCalendarItem_eps';
     ...
     * Sets estimated
     *
     * @param double $estimated EPS predicted
     *
     * @return $this
     */
     ...
     * Sets prior
     *
     * @param double $prior EPS reported for the same period a year ago
     *
     * @return $this
     */
     ...
     * Sets reported
     *
     * @param double $reported EPS reported
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of the earnings
     *
     * @return $this
     */
