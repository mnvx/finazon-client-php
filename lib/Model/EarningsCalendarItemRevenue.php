...
/**
 * EarningsCalendarItemRevenue Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EarningsCalendarItemRevenue implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EarningsCalendarItem_revenue';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['surprise'] = isset($data['surprise']) ? $data['surprise'] : null;
        $this->container['surprise_percent'] = isset($data['surprise_percent']) ? $data['surprise_percent'] : null;
     ...
     * Sets estimated
     *
     * @param double $estimated Revenue predicted
     *
     * @return $this
     */
     ...
     * Sets prior
     *
     * @param double $prior Revenue reported for the same period a year ago
     *
     * @return $this
     */
     ...
     * Sets reported
     *
     * @param double $reported Revenue reported
     *
     * @return $this
     */
     ...
     * Sets surprise
     *
     * @param double $surprise Difference between the predicted and the actual reported value
     *
     * @return $this
     */
     ...
     *
     * @param double $surprise_percent Percentage difference between the predicted and the actual reported value
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of the revenue
     *
     * @return $this
     */
