...
/**
 * SymbolUSStocks Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SymbolUSStocks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SymbolUSStocks';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['composite_figi'] = isset($data['composite_figi']) ? $data['composite_figi'] : null;
        ...
        $this->container['share_figi'] = isset($data['share_figi']) ? $data['share_figi'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mic'] === null) {
            $invalidProperties[] = "'mic' can't be null";
        }
     ...
     * Sets composite_figi
     *
     * @param string $composite_figi FIGI Composite code
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency Currency of the instrument according to the ISO 4217 standard
     *
     * @return $this
     */
     ...
     * Sets security
     *
     * @param string $security Security name
     *
     * @return $this
     */
    ...
    {
        return $this->container['share_figi'];
    }

    /**
     * Sets share_figi
     *
     * @param string $share_figi FIGI share class code
     *
     * @return $this
     */
    public function setShareFigi($share_figi)
    {
        $this->container['share_figi'] = $share_figi;
     ...
     * Sets ticker
     *
     * @param string $ticker Instrument symbol (ticker)
     *
     * @return $this
     */
