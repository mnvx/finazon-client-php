...
class Filing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Filing';
    ...
    protected static $swaggerTypes = [
        'cik' => 'int',
        'filed_at' => 'int',
        'files' => '\Swagger\Client\Model\FilingFile[]',
        'filing_url' => 'string',
        'form_type' => 'string',
        'ticker' => 'string[]'
    ];
     ...
     * Sets filed_at
     *
     * @param int $filed_at Filing date in UNIX timestamp
     *
     * @return $this
     */
     ...
     * Gets files
     *
     * @return \Swagger\Client\Model\FilingFile[]
     */
     ...
     * Sets files
     *
     * @param \Swagger\Client\Model\FilingFile[] $files Filing files
     *
     * @return $this
     */
     ...
     * Sets filing_url
     *
     * @param string $filing_url Full URL of the filing
     *
     * @return $this
     */
     ...
     * Sets form_type
     *
     * @param string $form_type Filing form type
     *
     * @return $this
     */
     ...
     * Sets ticker
     *
     * @param string[] $ticker List of tickers
     *
     * @return $this
     */
