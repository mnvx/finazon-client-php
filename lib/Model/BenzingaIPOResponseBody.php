...
/**
 * BenzingaIPOResponseBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BenzingaIPOResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BenzingaIPOResponseBody';
    ...
    protected static $swaggerTypes = [
        'ipos' => '\Swagger\Client\Model\IPOItem[]'
    ];
    ...
    {
        $this->container['ipos'] = isset($data['ipos']) ? $data['ipos'] : null;
    }
     ...
     * Gets ipos
     *
     * @return \Swagger\Client\Model\IPOItem[]
     */
    public function getIpos()
    {
        return $this->container['ipos'];
    }

    /**
     * Sets ipos
     *
     * @param \Swagger\Client\Model\IPOItem[] $ipos ipos
     *
     * @return $this
     */
    public function setIpos($ipos)
    {
        $this->container['ipos'] = $ipos;
