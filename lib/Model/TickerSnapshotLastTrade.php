...
/**
 * TickerSnapshotLastTrade Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TickerSnapshotLastTrade implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TickerSnapshotLastTrade';
     ...
     * Sets tm
     *
     * @param int $tm Timestamp in millisencds
     *
     * @return $this
     */
     ...
     * Sets p
     *
     * @param object $p core_entity.Price
     *
     * @return $this
     */
