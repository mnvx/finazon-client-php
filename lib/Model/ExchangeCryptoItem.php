...
/**
 * ExchangeCryptoItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExchangeCryptoItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExchangeCryptoItem';
     ...
     * Sets code
     *
     * @param string $code Finazon's identification code for the exchange
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Official name of the cryptocurrency exchange
     *
     * @return $this
     */
