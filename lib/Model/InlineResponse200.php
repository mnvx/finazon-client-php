...
class InlineResponse200 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        '_1d' => '\Swagger\Client\Model\TickerSnapshotLastDay',
        '_1m' => '\Swagger\Client\Model\TickerSnapshotLastMonth',
        '_52w' => '\Swagger\Client\Model\TickerSnapshotLastFiftyTwoWeek',
        'ch' => '\Swagger\Client\Model\TickerSnapshotChange',
        'lt' => '\Swagger\Client\Model\TickerSnapshotLastTrade',
        'p1d' => '\Swagger\Client\Model\TickerSnapshotPreviousDay'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_1m'] = isset($data['_1m']) ? $data['_1m'] : null;
        $this->container['_52w'] = isset($data['_52w']) ? $data['_52w'] : null;
        $this->container['ch'] = isset($data['ch']) ? $data['ch'] : null;
        $this->container['lt'] = isset($data['lt']) ? $data['lt'] : null;
        $this->container['p1d'] = isset($data['p1d']) ? $data['p1d'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_1d'] === null) {
            $invalidProperties[] = "'_1d' can't be null";
        }
        if ($this->container['_1m'] === null) {
            $invalidProperties[] = "'_1m' can't be null";
        }
        if ($this->container['_52w'] === null) {
            $invalidProperties[] = "'_52w' can't be null";
        }
        if ($this->container['ch'] === null) {
            $invalidProperties[] = "'ch' can't be null";
        }
        if ($this->container['lt'] === null) {
            $invalidProperties[] = "'lt' can't be null";
        }
        if ($this->container['p1d'] === null) {
            $invalidProperties[] = "'p1d' can't be null";
        }
     ...
     * Gets _1d
     *
     * @return \Swagger\Client\Model\TickerSnapshotLastDay
     */
     ...
     * Sets _1d
     *
     * @param \Swagger\Client\Model\TickerSnapshotLastDay $_1d _1d
     *
     * @return $this
     */
     ...
     * Gets _1m
     *
     * @return \Swagger\Client\Model\TickerSnapshotLastMonth
     */
    public function get1m()
    {
        return $this->container['_1m'];
    }

    /**
     * Sets _1m
     *
     * @param \Swagger\Client\Model\TickerSnapshotLastMonth $_1m _1m
     *
     * @return $this
     */
    public function set1m($_1m)
    {
        $this->container['_1m'] = $_1m;
     ...
     * Gets _52w
     *
     * @return \Swagger\Client\Model\TickerSnapshotLastFiftyTwoWeek
     */
    public function get52w()
    {
        return $this->container['_52w'];
    }

    /**
     * Sets _52w
     *
     * @param \Swagger\Client\Model\TickerSnapshotLastFiftyTwoWeek $_52w _52w
     *
     * @return $this
     */
    public function set52w($_52w)
    {
        $this->container['_52w'] = $_52w;
     ...
     * Gets ch
     *
     * @return \Swagger\Client\Model\TickerSnapshotChange
     */
     ...
     * Sets ch
     *
     * @param \Swagger\Client\Model\TickerSnapshotChange $ch ch
     *
     * @return $this
     */
     ...
     * Gets lt
     *
     * @return \Swagger\Client\Model\TickerSnapshotLastTrade
     */
     ...
     * Sets lt
     *
     * @param \Swagger\Client\Model\TickerSnapshotLastTrade $lt lt
     *
     * @return $this
     */
     ...
     * Gets p1d
     *
     * @return \Swagger\Client\Model\TickerSnapshotPreviousDay
     */
    public function getP1d()
    {
        return $this->container['p1d'];
    }

    /**
     * Sets p1d
     *
     * @param \Swagger\Client\Model\TickerSnapshotPreviousDay $p1d p1d
     *
     * @return $this
     */
    public function setP1d($p1d)
    {
        $this->container['p1d'] = $p1d;
