...
/**
 * TickerSnapshotChange Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TickerSnapshotChange implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TickerSnapshotChange';
    ...
    {
        $this->container['dap'] = isset($data['dap']) ? $data['dap'] : null;
        $this->container['wep'] = isset($data['wep']) ? $data['wep'] : null;
        $this->container['mop'] = isset($data['mop']) ? $data['mop'] : null;
    }
    ...
    {
        return $this->container['dap'];
    }

    /**
     * Sets dap
     *
     * @param double $dap Daily change price percent
     *
     * @return $this
     */
    ...
    {
        return $this->container['wep'];
    }

    /**
     * Sets wep
     *
     * @param double $wep Weekly change price percent
     *
     * @return $this
     */
    public function setWep($wep)
    {
        $this->container['wep'] = $wep;
    ...
    {
        return $this->container['mop'];
    }

    /**
     * Sets mop
     *
     * @param double $mop Monthly change price percent
     *
     * @return $this
     */
    public function setMop($mop)
    {
        $this->container['mop'] = $mop;
