...
/**
 * TechnicalIndicatorResponseMa Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TechnicalIndicatorResponseMa implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TechnicalIndicatorResponseMa';
    ...
    {
        $this->container['ma'] = isset($data['ma']) ? $data['ma'] : null;
     ...
     * Sets ma
     *
     * @param string $ma Moving Average indicator value
     *
     * @return $this
     */
